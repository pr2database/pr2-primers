...
latex_table(table = table_primers,
            caption = "Number of primers listed in the pr2-primer database",
            label = "tab:primers",
...
latex_table(table = table_primer_sets,
            caption = "Number of primer sets listed in the pr2-primer database",
...
latex_table(table = table_primer_sets_ampli,
            caption = "Overall characteristics of primer sets listed in the PR2 primer database",
...
latex_table(table = table,
            caption = "List of primers in the pr2-primer database. The start position is relative to the sequence of the yeast Saccharomyces cerevisiae (FU970071).",
...
```
## Fig - Primer sets position

```{r fig.height=12, fig.width=8}

reorder_primer<- function (x, y) {x+0.01*(y-x)}

fig <- ggplot(filter(primer_sets, !is.na(fwd_start_yeast))) +
  geom_segment(aes(
    x = fwd_start_yeast, 
    xend = rev_end_yeast,
    y = forcats::fct_reorder2(primer_set_name, fwd_start_yeast,rev_end_yeast, reorder_primer), 
    yend = forcats::fct_reorder2(primer_set_name, fwd_start_yeast,rev_end_yeast, reorder_primer),
    color = specific
  ),
  size = 3
  ) +

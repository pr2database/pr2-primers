...
latex_table(table = table_primers,
            caption = "Type of primers listed in the pr2-primer database. General primers target all eukaryotes and specific only certain taxonomic groups.",
            label = "tab:primers",
...
latex_table(table = table_primer_sets,
            caption = "Regions of the 18S rRNA gene targeted by the primer sets from the pr2-primer database.",
